...
=======
  ...
  // Non-hook combat gating (between hook zones)
  private nonHookCombatRegions: {
    start: number;
    end: number;
    targetHookZoneIndex: number;
    remainingEnemies: number;
    isCleared: boolean;
  }[] = [];
  private nonHookRegionByEntity = new WeakMap<object, number>();
  private nonHookBarrierHintCooldownUntil = 0;
...
>>>>>>> Realcodex
    ...
    this.initializeNonHookCombatRegions();
...
<<<<<<< HEAD
    const defs = [
      ...
      {
        x: this.map.widthInPixels / 2 + 1800,
        y: this.map.heightInPixels - 16,
        width: this.map.widthInPixels + 8000,
        height: 40,
      },
      
      // Section 1: Extended starting area platforms (tutorial zone)
      { x: 200, y: bandY, width: 220, height: 18 },
      { x: 340, y: bandY - 20, width: 140, height: 18 },   // Player-feet helper platform near spawn
      { x: 450, y: bandY - 40, width: 160, height: 18 },    // New intermediate platform
      { x: 650, y: bandY - 80, width: 180, height: 18 },    // Moved from 500
      { x: 850, y: bandY - 120, width: 140, height: 18 },   // New platform before demon
      { x: 780, y: bandY - 160, width: 200, height: 18 },
      { x: 380, y: bandY - 220, width: 140, height: 18 },
      
      // Section 2: Gap jumps
      { x: 950, y: bandY - 40, width: 120, height: 18 },
      { x: 1120, y: bandY - 100, width: 140, height: 18 },
      { x: 1300, y: bandY - 160, width: 160, height: 18 },
      
      // Section 3: First vertical climb
      { x: 1480, y: bandY - 80, width: 100, height: 18 },
      { x: 1580, y: bandY - 140, width: 100, height: 18 },
      { x: 1480, y: bandY - 200, width: 100, height: 18 },
      { x: 1580, y: bandY - 260, width: 100, height: 18 },
      
      // Section 4: High platforms
      { x: 1750, y: bandY - 280, width: 180, height: 18 },
      { x: 1950, y: bandY - 200, width: 140, height: 18 },
      { x: 2100, y: bandY - 120, width: 160, height: 18 },
      { x: 2280, y: bandY - 180, width: 120, height: 18 },
      { x: 2450, y: bandY - 240, width: 200, height: 18 },
      
      // Section 5: Extended mid area
      { x: 2650, y: bandY - 140, width: 140, height: 18 },
      { x: 2820, y: bandY - 80, width: 120, height: 18 },
      { x: 2980, y: bandY - 160, width: 150, height: 18 },
      { x: 3150, y: bandY - 220, width: 130, height: 18 },
      
      // Section 6: Long descent platforms
      { x: 3300, y: bandY - 180, width: 110, height: 18 },
      { x: 3440, y: bandY - 130, width: 120, height: 18 },
      { x: 3600, y: bandY - 80, width: 140, height: 18 },
      { x: 3780, y: bandY - 40, width: 130, height: 18 },
      
      // Section 7: Second climb section
      { x: 3920, y: bandY - 100, width: 100, height: 18 },
      { x: 4020, y: bandY - 160, width: 100, height: 18 },
      { x: 3920, y: bandY - 220, width: 100, height: 18 },
      { x: 4020, y: bandY - 280, width: 100, height: 18 },
      
      // Section 8: Final gauntlet - high platforms
      { x: 4200, y: bandY - 260, width: 150, height: 18 },
      { x: 4380, y: bandY - 200, width: 130, height: 18 },
      { x: 4550, y: bandY - 150, width: 140, height: 18 },
      { x: 4720, y: bandY - 220, width: 160, height: 18 },
      
      // Section 9: Final platforms before checkpoint
      { x: 4900, y: bandY - 280, width: 180, height: 18 },
      { x: 5100, y: bandY - 200, width: 200, height: 18 },
      { x: 5300, y: bandY - 260, width: 220, height: 18 },
      
      // Section 10: Extended area - new platforms
      { x: 5500, y: bandY - 180, width: 160, height: 18 },
      { x: 5700, y: bandY - 240, width: 140, height: 18 },
      { x: 5900, y: bandY - 160, width: 150, height: 18 },
      { x: 6100, y: bandY - 220, width: 130, height: 18 },
      { x: 6300, y: bandY - 100, width: 180, height: 18 },
      { x: 6500, y: bandY - 200, width: 140, height: 18 },
      { x: 6700, y: bandY - 280, width: 160, height: 18 },
      { x: 6900, y: bandY - 140, width: 150, height: 18 },
      { x: 7100, y: bandY - 240, width: 130, height: 18 },
      { x: 7300, y: bandY - 180, width: 160, height: 18 },
      { x: 7500, y: bandY - 260, width: 140, height: 18 },
      { x: 7700, y: bandY - 120, width: 150, height: 18 },
      { x: 7900, y: bandY - 200, width: 130, height: 18 },
      { x: 8100, y: bandY - 280, width: 180, height: 18 },
      { x: 8300, y: bandY - 160, width: 140, height: 18 },
      { x: 8500, y: bandY - 240, width: 150, height: 18 },
      { x: 8700, y: bandY - 100, width: 160, height: 18 },
      { x: 8900, y: bandY - 220, width: 140, height: 18 },
      { x: 9100, y: bandY - 280, width: 130, height: 18 },
      { x: 9300, y: bandY - 180, width: 150, height: 18 },
...
=======
    ...
    const defs = [
      ...
      { x: 320, y: bandY - 25, width: 150, height: 18 }, // Player-feet helper platform near spawn
      { x: 400, y: bandY - 60, width: 150, height: 18 },
      { x: 600, y: bandY - 100, width: 160, height: 18 },
      { x: 740, y: bandY - 75, width: 130, height: 18 }, // Added at player-feet location for easier jump
...
<<<<<<< HEAD
  private buildHazards() {
    ...
    // Static spikes throughout the level - significantly expanded
    const staticSpikes = [
      ...
      // Section 3: Vertical climb section
      { x: 1530, y: bandY - 85 },
      { x: 1630, y: bandY - 145 },
      
      // Section 4: Upper area
      { x: 1850, y: bandY - 205 },
      { x: 2020, y: bandY - 125 },
      { x: 2180, y: bandY - 185 },
      { x: 2350, y: bandY - 245 },
      ...
      // Section 6: Long descent
      { x: 3230, y: bandY - 185 },
      { x: 3370, y: bandY - 135 },
      { x: 3520, y: bandY - 85 },
      { x: 3700, y: bandY - 45 },
      
      // Section 7: Second climb
      { x: 3970, y: bandY - 105 },
      { x: 4070, y: bandY - 165 },
      { x: 3970, y: bandY - 225 },
      ...
      // Section 9: Final area
      { x: 4820, y: bandY - 285 },
      { x: 5020, y: bandY - 205 },
      { x: 5220, y: bandY - 265 },
      
      // Section 10: Extended area hazards
      { x: 5420, y: bandY - 185 },
      { x: 5620, y: bandY - 245 },
      { x: 5820, y: bandY - 165 },
      { x: 6020, y: bandY - 225 },
    ...
    staticSpikes.forEach((def) => this.addHazardSpike(def.x, def.y));

    // Lava pools - expanded throughout level
    this.addLavaPool(450, bandY - 5, 80, 10);
    this.addLavaPool(850, bandY - 5, 100, 10);
    this.addLavaPool(1350, bandY - 5, 120, 10);
    this.addLavaPool(1900, bandY - 5, 90, 10);
    this.addLavaPool(2250, bandY - 5, 110, 10);
    this.addLavaPool(2550, bandY - 5, 95, 10);
    this.addLavaPool(3050, bandY - 5, 130, 10);
    this.addLavaPool(3450, bandY - 5, 100, 10);
    this.addLavaPool(3850, bandY - 5, 120, 10);
    this.addLavaPool(4250, bandY - 5, 110, 10);
    this.addLavaPool(4650, bandY - 5, 100, 10);
    this.addLavaPool(5050, bandY - 5, 120, 10);
    this.addLavaPool(5450, bandY - 5, 110, 10);
    this.addLavaPool(5850, bandY - 5, 100, 10);
    this.addLavaPool(6250, bandY - 5, 130, 10);
    this.addLavaPool(6650, bandY - 5, 110, 10);
    this.addLavaPool(7050, bandY - 5, 100, 10);
    this.addLavaPool(7450, bandY - 5, 120, 10);
    this.addLavaPool(7850, bandY - 5, 110, 10);
    this.addLavaPool(8250, bandY - 5, 100, 10);
    this.addLavaPool(8650, bandY - 5, 130, 10);
    this.addLavaPool(9050, bandY - 5, 110, 10);
    this.addLavaPool(9450, bandY - 5, 100, 10);
    this.addLavaPool(9850, bandY - 5, 120, 10);

    // Moving hazards - significantly more throughout level
    // Section 1-2
    this.addMovingHazard(280, bandY - 120, 26, 24, 'x', 140, 80);
    this.addMovingHazard(720, bandY - 200, 26, 24, 'x', 220, -90);
    this.addMovingHazard(520, bandY - 40, 26, 24, 'y', 90, 70);
    this.addMovingHazard(1050, bandY - 140, 26, 24, 'x', 160, 100);
    
    // Section 3-4
    this.addMovingHazard(1280, bandY - 200, 26, 24, 'y', 100, -80);
    this.addMovingHazard(1530, bandY - 180, 26, 24, 'x', 180, -110);
    this.addMovingHazard(1820, bandY - 240, 26, 24, 'x', 200, 95);
    this.addMovingHazard(2050, bandY - 160, 26, 24, 'y', 120, 85);
    this.addMovingHazard(2350, bandY - 200, 26, 24, 'x', 140, -100);
    
    // Section 5-6
    this.addMovingHazard(2700, bandY - 120, 26, 24, 'x', 150, 90);
    this.addMovingHazard(2950, bandY - 200, 26, 24, 'y', 110, -75);
    this.addMovingHazard(3180, bandY - 180, 26, 24, 'x', 170, -95);
    this.addMovingHazard(3480, bandY - 110, 26, 24, 'y', 90, 80);
    this.addMovingHazard(3700, bandY - 60, 26, 24, 'x', 130, 100);
    
    // Section 7-8
    this.addMovingHazard(3970, bandY - 190, 26, 24, 'x', 160, -110);
    this.addMovingHazard(4170, bandY - 240, 26, 24, 'y', 130, 85);
    this.addMovingHazard(4420, bandY - 180, 26, 24, 'x', 140, 95);
    this.addMovingHazard(4650, bandY - 200, 26, 24, 'y', 120, -90);
    
    // Section 9
    this.addMovingHazard(4880, bandY - 260, 26, 24, 'x', 150, 100);
    this.addMovingHazard(5120, bandY - 180, 26, 24, 'x', 160, -105);
...
<<<<<<< HEAD
    ...
    const demonSpawns = [
      { x: 1200, y: this.spawnPoint.y - 150 },  // Mid-early
      { x: 1800, y: this.spawnPoint.y - 100 },  // Before climb
      { x: 2500, y: this.spawnPoint.y - 200 },  // High platforms
      { x: 3200, y: this.spawnPoint.y - 120 },  // Extended area
      { x: 3800, y: this.spawnPoint.y - 80 },   // Descent area
      { x: 4500, y: this.spawnPoint.y - 180 },  // Final gauntlet
      { x: 5000, y: this.spawnPoint.y - 250 },  // Near end
      // Extended area demons
      { x: 5600, y: this.spawnPoint.y - 200 },  // Extended area 1
      { x: 6200, y: this.spawnPoint.y - 120 },  // Extended area 2
      { x: 6800, y: this.spawnPoint.y - 260 },  // Extended area 3
      { x: 7400, y: this.spawnPoint.y - 180 },  // Extended area 4
      { x: 8000, y: this.spawnPoint.y - 240 },  // Extended area 5
...
>>>>>>> Realcodex
    ...
    this.registerCombatEntityInNonHookRegion(demonData, x);
  ...
  private killDemon(demon: any) {
    if (!demon || !demon.sprite || !demon.sprite.active) return;
    console.log('☠️ Demon defeated!');
    this.markCombatEntityDefeatedInNonHookRegion(demon);
...
<<<<<<< HEAD
    ...
    const allPlatformPositions = [
      { x: 200, y: bandY, width: 220 },
      { x: 450, y: bandY - 40, width: 160 },
      { x: 650, y: bandY - 80, width: 180 },
      { x: 850, y: bandY - 120, width: 140 },
      { x: 780, y: bandY - 160, width: 200 },
      { x: 380, y: bandY - 220, width: 140 },
      { x: 950, y: bandY - 40, width: 120 },
      { x: 1120, y: bandY - 100, width: 140 },
      { x: 1300, y: bandY - 160, width: 160 },
      { x: 1480, y: bandY - 80, width: 100 },
      { x: 1580, y: bandY - 140, width: 100 },
      { x: 1480, y: bandY - 200, width: 100 },
      { x: 1580, y: bandY - 260, width: 100 },
      { x: 1750, y: bandY - 280, width: 180 },
      { x: 1950, y: bandY - 200, width: 140 },
      { x: 2100, y: bandY - 120, width: 160 },
      { x: 2280, y: bandY - 180, width: 120 },
      { x: 2450, y: bandY - 240, width: 200 },
      { x: 2650, y: bandY - 140, width: 140 },
      { x: 2820, y: bandY - 80, width: 120 },
      { x: 2980, y: bandY - 160, width: 150 },
      { x: 3150, y: bandY - 220, width: 130 },
      { x: 3300, y: bandY - 180, width: 110 },
      { x: 3440, y: bandY - 130, width: 120 },
      { x: 3600, y: bandY - 80, width: 140 },
      { x: 3780, y: bandY - 40, width: 130 },
      { x: 3920, y: bandY - 100, width: 100 },
      { x: 4020, y: bandY - 160, width: 100 },
      { x: 3920, y: bandY - 220, width: 100 },
      { x: 4020, y: bandY - 280, width: 100 },
      { x: 4200, y: bandY - 260, width: 150 },
      { x: 4380, y: bandY - 200, width: 130 },
      { x: 4550, y: bandY - 150, width: 140 },
      { x: 4720, y: bandY - 220, width: 160 },
      { x: 4900, y: bandY - 280, width: 180 },
      { x: 5100, y: bandY - 200, width: 200 },
      { x: 5300, y: bandY - 260, width: 220 },
      // Extended area platforms for letter placement
      { x: 5500, y: bandY - 180, width: 160 },
      { x: 5700, y: bandY - 240, width: 140 },
      { x: 5900, y: bandY - 160, width: 150 },
      { x: 6100, y: bandY - 220, width: 130 },
      { x: 6300, y: bandY - 100, width: 180 },
      { x: 6500, y: bandY - 200, width: 140 },
      { x: 6700, y: bandY - 280, width: 160 },
      { x: 6900, y: bandY - 140, width: 150 },
      { x: 7100, y: bandY - 240, width: 130 },
      { x: 7300, y: bandY - 180, width: 160 },
      { x: 7500, y: bandY - 260, width: 140 },
      { x: 7700, y: bandY - 120, width: 150 },
      { x: 7900, y: bandY - 200, width: 130 },
      { x: 8100, y: bandY - 280, width: 180 },
      { x: 8300, y: bandY - 160, width: 140 },
      { x: 8500, y: bandY - 240, width: 150 },
      { x: 8700, y: bandY - 100, width: 160 },
      { x: 8900, y: bandY - 220, width: 140 },
      { x: 9100, y: bandY - 280, width: 130 },
      { x: 9300, y: bandY - 180, width: 150 },
...
<<<<<<< HEAD
    ...
    // Generate letters for each platform (3-5 letters per platform)
    const letterPlacements: { x: number; y: number; letter: string; isRequired: boolean }[] = [];
    
    // GUARANTEE all required letters are placed first
    const requiredLettersCopy = [...wordLetters];
    const shuffledPlatforms = [...allPlatformPositions].sort(() => Math.random() - 0.5);
    
    // First pass: Place ALL required letters (guaranteed placement)
    requiredLettersCopy.forEach((letter, index) => {
      const platform = shuffledPlatforms[index % shuffledPlatforms.length];
      const letterX = platform.x + (Math.random() - 0.5) * (platform.width * 0.6); // Random position on platform
    ...
    // Second pass: Fill remaining space with extra letters
    allPlatformPositions.forEach((platform) => {
      const lettersOnThisPlatform = 2; // Target 2 letters per platform
      
      // Count how many letters are already on this platform
      const existingLettersOnPlatform = letterPlacements.filter(placement => 
        Math.abs(placement.x - platform.x) < platform.width/2 && 
        Math.abs(placement.y - platform.y) < 10
      ).length;
      
      // Add extra letters to reach the target count
      const lettersToAdd = Math.max(0, lettersOnThisPlatform - existingLettersOnPlatform);
      
      for (let i = 0; i < lettersToAdd; i++) {
        const randomLetter = extraLetters[Math.floor(Math.random() * extraLetters.length)];
        const letterSpacing = platform.width / (lettersToAdd + 1);
        const letterX = platform.x - platform.width/2 + letterSpacing * (i + 1);
    ...
    this.currentWordLetterMap = letterPlacements;
    
    // Verify all required letters are present
    const requiredLettersFound = letterPlacements.filter(p => p.isRequired).map(p => p.letter);
    const missingRequiredLetters = wordLetters.filter(letter => !requiredLettersFound.includes(letter));
    ...
    if (missingRequiredLetters.length > 0) {
      ...
      console.log(`✅ All required letters spawned successfully!`);
    }
...
<<<<<<< HEAD
    ...
    const positions = this.getLetterPlacements(word);
    
    // Spawn all letters (required + extra) using the letter mapping
...
<<<<<<< HEAD
    ...
    console.log(`Spawning letter ${letter} at (${targetX}, ${targetY}), landing at (${targetX}, ${landingY}), required: ${isRequired}`);

    // Different colors for required vs extra letters
    const letterColor = isRequired ? '#ffffff' : '#cccccc';
    const strokeColor = isRequired ? '#000000' : '#333333';
...
<<<<<<< HEAD
    ...
    // Mark letter as collected (tint blue)
    letterText.setTint(0x3b82f6);
    
    // Remove interactivity so it can't be collected again
    letterText.disableInteractive();

=======
    const nodeIndexData = letterText.getData('index') as number | undefined;
    if (nodeIndexData !== undefined) {
      const nodeZoneIndex = Math.floor(nodeIndexData / 10);
      if (
        nodeZoneIndex > 0 &&
        nodeZoneIndex < this.hookZoneDefinitions.length &&
        !this.isHookZoneUnlockedByCombat(nodeZoneIndex)
      ) {
        this.showNonHookBarrierHint(nodeZoneIndex);
        return;
      }
    }
...
<<<<<<< HEAD
        ...
        this.updateCheckpointPosition(targetX, landingY);

        // Check for spell word completion
        this.checkSpellWordCompletion(letter);
...
<<<<<<< HEAD
    ...
    // Create or update a display showing collected letters
    if (this.collectedLettersText) {
      this.collectedLettersText.destroy();
    }
    
    this.collectedLettersText = this.add.text(50, 50, `Collected: ${this.collectedLetters.join(' ')}`, {
      fontFamily: 'monospace',
      fontSize: '16px',
      color: '#ffffff',
      stroke: '#000000',
...
>>>>>>> Realcodex
  ...
  private initializeNonHookCombatRegions() {
    this.nonHookCombatRegions = [];
    this.nonHookRegionByEntity = new WeakMap<object, number>();
    this.nonHookBarrierHintCooldownUntil = 0;

    for (let i = 1; i < this.hookZoneDefinitions.length; i++) {
      const previousZone = this.hookZoneDefinitions[i - 1];
      const nextZone = this.hookZoneDefinitions[i];
      this.nonHookCombatRegions.push({
        start: previousZone.end,
        end: nextZone.start,
        targetHookZoneIndex: i,
        remainingEnemies: 0,
        isCleared: false,
      });
    }
  ...
  private getNonHookRegionIndexForZone(zoneIndex: number): number {
    return this.nonHookCombatRegions.findIndex((region) => region.targetHookZoneIndex === zoneIndex);
  }

  private getNonHookRegionIndexForX(x: number): number {
    return this.nonHookCombatRegions.findIndex((region) => x >= region.start && x <= region.end);
  }

  private registerCombatEntityInNonHookRegion(entity: object, worldX: number) {
    if (!entity || this.nonHookRegionByEntity.has(entity)) return;

    const regionIndex = this.getNonHookRegionIndexForX(worldX);
    if (regionIndex < 0) return;

    const region = this.nonHookCombatRegions[regionIndex];
    if (!region || region.isCleared) return;

    this.nonHookRegionByEntity.set(entity, regionIndex);
    region.remainingEnemies += 1;
  }

  private markCombatEntityDefeatedInNonHookRegion(entity: object) {
    const regionIndex = this.nonHookRegionByEntity.get(entity);
    if (regionIndex === undefined) return;

    this.nonHookRegionByEntity.delete(entity);
    const region = this.nonHookCombatRegions[regionIndex];
    if (!region || region.isCleared) return;

    region.remainingEnemies = Math.max(0, region.remainingEnemies - 1);
    if (region.remainingEnemies === 0) {
      region.isCleared = true;
      console.log(`🔓 Combat gate cleared before hook zone ${region.targetHookZoneIndex + 1}`);
    }
  }

  private reconcileNonHookRegionEnemyCount(regionIndex: number) {
    const region = this.nonHookCombatRegions[regionIndex];
    if (!region || region.isCleared) return;
    ...
    this.demons.forEach((demon) => {
      if (!demon || !demon.sprite || !demon.sprite.active) return;
      if (demon.health <= 0) return;
      if (demon.sprite.x >= region.start && demon.sprite.x <= region.end) {
        liveCount += 1;
      }
    });
    ...
    this.enemies.forEach((enemy) => {
      ...
      if (enemy.sprite.x >= region.start && enemy.sprite.x <= region.end) {
        liveCount += 1;
      }
    });

    region.remainingEnemies = liveCount;
    if (region.remainingEnemies === 0) {
      region.isCleared = true;
      console.log(`🔓 Combat gate cleared before hook zone ${region.targetHookZoneIndex + 1}`);
    }
  ...
  private isHookZoneUnlockedByCombat(zoneIndex: number): boolean {
    if (zoneIndex <= 0) return true; // First hook zone has no preceding non-hook gate

    const regionIndex = this.getNonHookRegionIndexForZone(zoneIndex);
    ...
    if (!region.isCleared) {
      this.reconcileNonHookRegionEnemyCount(regionIndex);
    }

    return region.isCleared;
  }

  private showNonHookBarrierHint(zoneIndex: number) {
    if (this.time.now < this.nonHookBarrierHintCooldownUntil) return;

    const zone = this.hookZoneDefinitions[zoneIndex];
    if (!zone) return;

    this.nonHookBarrierHintCooldownUntil = this.time.now + 700;

    const hintX = zone.start + 120;
    const hintY = this.map.heightInPixels - 170;
  ...
  private blockHookZoneEntry(zoneIndex: number) {
    const zone = this.hookZoneDefinitions[zoneIndex];
    if (!zone) return;

    const body = this.player.body as Phaser.Physics.Arcade.Body | undefined;
    if (this.player.x >= zone.start && this.player.x <= zone.end) {
      const distToStart = Math.abs(this.player.x - zone.start);
      const distToEnd = Math.abs(zone.end - this.player.x);
      if (distToStart <= distToEnd) {
        this.player.x = zone.start - 20;
        if (body) body.setVelocityX(Math.min(0, body.velocity.x));
      } else {
        this.player.x = zone.end + 20;
        if (body) body.setVelocityX(Math.max(0, body.velocity.x));
      }
    }

    this.showNonHookBarrierHint(zoneIndex);
  }
...
=======
  ...
  private checkHookZoneStatus() {
    ...
    if (inZone && !this.isInHookZone) {
      if (!this.isHookZoneUnlockedByCombat(zoneIndex)) {
        this.blockHookZoneEntry(zoneIndex);
        return;
      }
...
<<<<<<< HEAD
  private spawnEnemies() {
    ...
    // Spawn enemies on various platforms
    const enemySpawns = [
      { x: 650, y: bandY - 80, patrolWidth: 100 },
      { x: 1120, y: bandY - 100, patrolWidth: 80 },
      { x: 1750, y: bandY - 280, patrolWidth: 120 },
      { x: 2450, y: bandY - 240, patrolWidth: 100 },
      { x: 3600, y: bandY - 80, patrolWidth: 90 },
      // Extended area enemies
      { x: 5500, y: bandY - 180, patrolWidth: 100 },
      { x: 6300, y: bandY - 100, patrolWidth: 90 },
      { x: 7100, y: bandY - 240, patrolWidth: 110 },
      { x: 7900, y: bandY - 200, patrolWidth: 100 },
      { x: 8700, y: bandY - 100, patrolWidth: 90 },
      { x: 9500, y: bandY - 240, patrolWidth: 120 },
    ];

    enemySpawns.forEach(spawn => {
      this.createEnemy(spawn.x, spawn.y, spawn.patrolWidth);
    });
  }
...
<<<<<<< HEAD
    ...
    this.registerCombatEntityInNonHookRegion(enemyData, x);
=======
    body.setCollideWorldBounds(true);
    body.setBounce(0);
...
>>>>>>> Realcodex
    this.markCombatEntityDefeatedInNonHookRegion(enemy);
...
<<<<<<< HEAD
  private createJumuf() {
    ...
    // Draw genie body (purple/blue gradient effect)
    graphics.fillStyle(0x8b5cf6, 1); // Purple
    graphics.fillCircle(0, 0, 20);
    graphics.fillStyle(0x6366f1, 0.8); // Indigo glow
    graphics.fillCircle(0, 0, 16);
    graphics.fillStyle(0xa78bfa, 1); // Light purple center
    graphics.fillCircle(0, 0, 12);
    
    // Draw genie "tail" (wispy bottom)
...
<<<<<<< HEAD
  ...
  private consecutiveCorrectCount: number = 0; // Track consecutive correct pronunciations for current word
  private requiredConsecutive: number = 2; // Each word must be said twice in a row
  private progress: boolean[] = []; // Will be initialized based on word count
  private isUnlocked: boolean = false;
  
  // Visual elements
  private doorSprite?: Phaser.Physics.Arcade.Sprite;
  private doorLeftHalf?: Phaser.GameObjects.Image;
  private doorRightHalf?: Phaser.GameObjects.Image;
  private doorCollider?: Phaser.Physics.Arcade.Collider;
  private doorOverlap?: Phaser.Physics.Arcade.Collider;
  private instructionText?: Phaser.GameObjects.Text;
  private challengeUI?: Phaser.GameObjects.Container;
  private currentWordText?: Phaser.GameObjects.Text;
  private progressMarkers: Phaser.GameObjects.Text[] = [];
  ...
  private playerPassedThrough: boolean = false;
  
  // Jumuf reference
  private jumufGiveHint?: (text: string) => void;
  private showJumuf?: () => void;

  constructor(scene: Phaser.Scene, x: number, y: number, requiredWords: string[], jumufGiveHint: (text: string) => void, showJumuf: () => void) {
    this.scene = scene;
    this.x = x;
    this.y = y;
    this.requiredWords = requiredWords.map(w => w.toUpperCase().trim());
    this.jumufGiveHint = jumufGiveHint;
    this.showJumuf = showJumuf;
...
<<<<<<< HEAD
    ...
    if (this.scene.textures.exists('dungeon_door')) {
      ...
      // Create door sprite - more prominent visual (fallback)
      const doorGraphics = this.scene.add.graphics();
      // Door frame (darker outer)
      doorGraphics.fillStyle(0x2a2a2a, 1);
      doorGraphics.fillRect(0, 0, 100, 140);
      // Door main body
      doorGraphics.fillStyle(0x4a4a4a, 1);
      doorGraphics.fillRect(5, 5, 90, 130);
      // Door panels (wood grain effect)
      doorGraphics.fillStyle(0x3a3a3a, 1);
      doorGraphics.fillRect(10, 10, 80, 25);
      doorGraphics.fillRect(10, 40, 80, 25);
      doorGraphics.fillRect(10, 70, 80, 25);
      doorGraphics.fillRect(10, 100, 80, 25);
      // Door handle (gold)
      doorGraphics.fillStyle(0xffd700, 1);
      doorGraphics.fillCircle(80, 70, 10);
      doorGraphics.fillStyle(0xffaa00, 1);
      doorGraphics.fillCircle(80, 70, 7);
      // Lock symbol (red, more prominent)
      doorGraphics.fillStyle(0xff0000, 1);
      doorGraphics.fillRect(35, 55, 30, 35);
      doorGraphics.fillStyle(0xffffff, 1);
      doorGraphics.fillRect(40, 60, 20, 25);
      doorGraphics.fillStyle(0x000000, 1);
      doorGraphics.fillRect(45, 65, 10, 15);
...
<<<<<<< HEAD
    ...
    const body = this.doorSprite.body as Phaser.Physics.Arcade.StaticBody;
    // Set body size - adjust if using dungeon door sprite
    if (this.scene.textures.exists('dungeon_door')) {
      // Use texture dimensions for dungeon door
      const texture = this.scene.textures.get('dungeon_door');
      const frame = texture.get(0);
      if (frame) {
        body.setSize(frame.width * 1.2, frame.height * 1.2);
      } else {
        body.setSize(100, 140); // Fallback size
      }
    } else {
      body.setSize(100, 140); // Match the generated door size
    }

    // Create collider with player
    this.doorCollider = this.scene.physics.add.collider(
    ...
    // Instruction text above door
    this.instructionText = this.scene.add.text(this.x, this.y - 80, 'PRESS G TO START PRONUNCIATION CHALLENGE', {
      fontFamily: 'monospace',
      fontSize: '16px',
      color: '#ffd700',
      stroke: '#000000',
...
<<<<<<< HEAD
    this.challengeUI = this.scene.add.container(400, 100)
      .setDepth(100)
      .setScrollFactor(0)
      .setAlpha(0) // Hidden initially - only show at end of game
      .setVisible(false);

    // Background panel - wider to accommodate 6 markers
    const bg = this.scene.add.rectangle(0, 0, 500, 150, 0x1a1a1a, 0.9)
      .setStrokeStyle(3, 0xffd700, 1);
    this.challengeUI.add(bg);

    // Current word text
    this.currentWordText = this.scene.add.text(0, -40, `Say: ${this.requiredWords[this.currentWordIndex]} (${this.consecutiveCorrectCount}/${this.requiredConsecutive})`, {
      fontFamily: 'monospace',
      fontSize: '24px',
      color: '#ffffff',
      stroke: '#000000',
    ...
    // Progress markers - 2 per word (6 total for 3 words)
    const totalMarkers = this.requiredWords.length * 2;
    const markerSpacing = 60;
    const startX = -((totalMarkers - 1) * markerSpacing) / 2;
    for (let i = 0; i < totalMarkers; i++) {
      const marker = this.scene.add.text(startX + (i * markerSpacing), 20, '✗', {
        fontFamily: 'monospace',
        fontSize: '24px',
        color: '#ff4444',
        stroke: '#000000',
      ...
      this.challengeUI.add(marker);
    }

    // Microphone icon
    const micGraphics = this.scene.add.graphics();
    micGraphics.fillStyle(0x60a5fa, 1);
    micGraphics.fillCircle(0, 0, 12);
    micGraphics.fillStyle(0xffffff, 1);
    micGraphics.fillRect(-3, -8, 6, 8);
    micGraphics.fillRect(-6, 4, 12, 3);
    micGraphics.generateTexture('mic_icon', 24, 24);
    micGraphics.destroy();

    this.micIcon = this.scene.add.image(0, 60, 'mic_icon')
      .setAlpha(0.5);
    this.challengeUI.add(this.micIcon);

    // Start blinking animation (will be active when visible)
    this.scene.tweens.add({
      ...
      repeat: -1,
      ease: 'Sine.easeInOut',
      paused: true // Pause until UI is shown
    });
  }

  private handleWordSpoken(spokenWord: string) {
    if (this.isUnlocked || !this.isListening) return;

    const normalizedSpoken = spokenWord.toUpperCase().trim();
    const currentRequired = this.requiredWords[this.currentWordIndex];
    
    console.log(`🎤 PronunciationDoor heard: "${normalizedSpoken}" | Required: "${currentRequired}"`);

    // More lenient matching function
    const checkMatch = (spoken: string, required: string): boolean => {
      // Exact match
      if (spoken === required) return true;
      
      // Contains match
      if (spoken.includes(required) || required.includes(spoken)) return true;
      
      // Remove common suffixes/prefixes and check
      const cleanSpoken = spoken.replace(/^(THE|A|AN)\s+/i, '').replace(/\s+(PLEASE|AGAIN)$/i, '');
      const cleanRequired = required.replace(/^(THE|A|AN)\s+/i, '').replace(/\s+(PLEASE|AGAIN)$/i, '');
      if (cleanSpoken === cleanRequired || cleanSpoken.includes(cleanRequired) || cleanRequired.includes(cleanSpoken)) return true;
      
      // Special handling for common mispronunciations
      const variations: { [key: string]: string[] } = {
        'CRYSTAL': ['CRISTAL', 'CRYSTEL', 'CRISTEL', 'CRYST', 'CRYSTL', 'CRISTL', 'CRYSTLE', 'CRYSTAL', 'CRISTAL'],
        'CHILL': ['CHIL', 'CHILLL', 'CHYL', 'CHILLE', 'CHIL', 'CHIL', 'CHIL', 'CHIL', 'CHIL', 'CHIL', 'CHIL', 'CHIL'],
        'BORED': ['BORD', 'BOARD', 'BORDE', 'BORRD', 'BOREDD', 'BOREDE']
      };
      
      // Also check if spoken word starts with first 3 letters of required word (for "Chill" -> "Chi...")
      if (required.length >= 3 && spoken.length >= 3) {
        if (spoken.substring(0, 3) === required.substring(0, 3)) {
          // If first 3 letters match and lengths are similar, likely a match
          if (Math.abs(spoken.length - required.length) <= 2) {
            return true;
          }
        }
      }
      ...
      if (variations[required]) {
        for (const variant of variations[required]) {
          if (spoken === variant || spoken.includes(variant) || variant.includes(spoken)) {
            return true;
          }
        }
      }
      
      // Fuzzy match - check if most characters match (for speech recognition errors)
      if (spoken.length >= required.length * 0.7 && required.length >= spoken.length * 0.7) {
        let matchingChars = 0;
        const minLength = Math.min(spoken.length, required.length);
        for (let i = 0; i < minLength; i++) {
          if (spoken[i] === required[i]) matchingChars++;
        }
        // If 70% of characters match, consider it a match
        if (matchingChars / minLength >= 0.7) return true;
      }
      
      return false;
    };

    const isMatch = checkMatch(normalizedSpoken, currentRequired);

    if (isMatch) {
      // Success! Increment consecutive correct count
      this.consecutiveCorrectCount++;
      this.failureCount = 0;
      this.idleTimer = 0;

      // Calculate which progress marker to update (2 per word)
      const markerIndex = (this.currentWordIndex * 2) + (this.consecutiveCorrectCount - 1);
      if (markerIndex < this.progressMarkers.length) {
        this.progress[markerIndex] = true;
        this.progressMarkers[markerIndex].setText('✓').setColor('#44ff44');
      }

      // Update current word text to show progress
      if (this.currentWordText) {
        this.currentWordText.setText(`Say: ${this.requiredWords[this.currentWordIndex]} (${this.consecutiveCorrectCount}/${this.requiredConsecutive})`);
        this.currentWordText.setColor('#44ff44');
        this.scene.time.delayedCall(300, () => {
          if (this.currentWordText) {
            this.currentWordText.setColor('#ffffff');
          }
        });
      }

      // Check if we've said the word twice in a row
      if (this.consecutiveCorrectCount >= this.requiredConsecutive) {
        // Word completed! Move to next word
        this.consecutiveCorrectCount = 0;
        this.currentWordIndex++;
        
        if (this.currentWordIndex >= this.requiredWords.length) {
          // All words completed - unlock door
          this.unlockDoor();
        } else {
          // Update current word text for next word
          if (this.currentWordText) {
            this.currentWordText.setText(`Say: ${this.requiredWords[this.currentWordIndex]} (${this.consecutiveCorrectCount}/${this.requiredConsecutive})`);
          }
        }
      ...
      // Failure - reset consecutive count (must say twice in a row)
      this.consecutiveCorrectCount = 0;
      this.failureCount++;
      this.idleTimer = 0;

      // Reset progress markers for current word if any were marked
      const startMarkerIndex = this.currentWordIndex * 2;
      for (let i = 0; i < 2; i++) {
        const markerIdx = startMarkerIndex + i;
        if (markerIdx < this.progressMarkers.length && this.progress[markerIdx]) {
          this.progress[markerIdx] = false;
          this.progressMarkers[markerIdx].setText('✗').setColor('#ff4444');
        }
      }

      // Show failure feedback
      if (this.currentWordText) {
        this.currentWordText.setColor('#ff4444');
        this.currentWordText.setText(`Say: ${this.requiredWords[this.currentWordIndex]} (0/${this.requiredConsecutive})`);
      ...
      // Check if Jumuf should help (3 failures or >10 seconds)
      if (this.failureCount >= 3) {
        this.showJumufHint();
        this.failureCount = 0; // Reset after hint
      }
    }
  }

  private showJumufHint() {
    if (!this.jumufGiveHint || !this.showJumuf) return;

    const currentWord = this.requiredWords[this.currentWordIndex].toLowerCase();
    let hint = '';

    // Generate hints based on word
    if (currentWord.includes('crystal')) {
      hint = 'Try saying "Crystal" slowly: "crys...tal...". Focus on the /cr/ and /tal/ sounds. Say it twice in a row!';
    } else if (currentWord.includes('chill')) {
      hint = 'Try focusing on the /ch/ sound at the beginning. Say it twice in a row!';
    } else if (currentWord.includes('bored')) {
      hint = 'Remember, "bored" rhymes with "board". Say it twice in a row!';
    } else {
      hint = `Try saying "${currentWord}" slowly and clearly. You need to say it twice in a row!`;
    }
...
<<<<<<< HEAD
    ...
    // Create door halves for burst animation
    if (this.doorSprite) {
      const doorX = this.doorSprite.x;
      const doorY = this.doorSprite.y;
      const doorWidth = 100;
      const doorHeight = 140;

      // Create left half texture (only if it doesn't exist)
      if (!this.scene.textures.exists('door_left')) {
        const leftGraphics = this.scene.add.graphics();
        leftGraphics.fillStyle(0x2a2a2a, 1);
        leftGraphics.fillRect(0, 0, doorWidth / 2, doorHeight);
        leftGraphics.fillStyle(0x4a4a4a, 1);
        leftGraphics.fillRect(2.5, 2.5, doorWidth / 2 - 5, doorHeight - 5);
        leftGraphics.fillStyle(0x3a3a3a, 1);
        leftGraphics.fillRect(5, 5, doorWidth / 2 - 10, 25);
        leftGraphics.fillRect(5, 40, doorWidth / 2 - 10, 25);
        leftGraphics.fillRect(5, 70, doorWidth / 2 - 10, 25);
        leftGraphics.fillRect(5, 100, doorWidth / 2 - 10, 25);
        leftGraphics.generateTexture('door_left', doorWidth / 2, doorHeight);
        leftGraphics.destroy();
      }

      // Create right half texture (only if it doesn't exist)
      if (!this.scene.textures.exists('door_right')) {
        const rightGraphics = this.scene.add.graphics();
        rightGraphics.fillStyle(0x2a2a2a, 1);
        rightGraphics.fillRect(0, 0, doorWidth / 2, doorHeight);
        rightGraphics.fillStyle(0x4a4a4a, 1);
        rightGraphics.fillRect(2.5, 2.5, doorWidth / 2 - 5, doorHeight - 5);
        rightGraphics.fillStyle(0x3a3a3a, 1);
        rightGraphics.fillRect(5, 5, doorWidth / 2 - 10, 25);
        rightGraphics.fillRect(5, 40, doorWidth / 2 - 10, 25);
        rightGraphics.fillRect(5, 70, doorWidth / 2 - 10, 25);
        rightGraphics.fillRect(5, 100, doorWidth / 2 - 10, 25);
        // Right half has the handle
        rightGraphics.fillStyle(0xffd700, 1);
        rightGraphics.fillCircle(doorWidth / 2 - 20, 70, 10);
        rightGraphics.fillStyle(0xffaa00, 1);
        rightGraphics.fillCircle(doorWidth / 2 - 20, 70, 7);
        rightGraphics.generateTexture('door_right', doorWidth / 2, doorHeight);
      ...
      // Create door halves
      this.doorLeftHalf = this.scene.add.image(doorX - doorWidth / 4, doorY, 'door_left')
        .setDepth(10)
        .setScale(1.2)
        .setOrigin(0.5, 0.5);
      
      this.doorRightHalf = this.scene.add.image(doorX + doorWidth / 4, doorY, 'door_right')
        .setDepth(10)
        .setScale(1.2)
        .setOrigin(0.5, 0.5);

      // Burst open animation - halves fly apart
      this.scene.tweens.add({
        targets: this.doorLeftHalf,
        x: doorX - doorWidth / 2 - 100,
        rotation: -Math.PI / 4,
        alpha: 0,
        duration: 800,
        ease: 'Power2.easeOut',
        onComplete: () => {
          if (this.doorLeftHalf) {
            this.doorLeftHalf.destroy();
          }
        }
      });

      this.scene.tweens.add({
        targets: this.doorRightHalf,
        x: doorX + doorWidth / 2 + 100,
        rotation: Math.PI / 4,
        alpha: 0,
        duration: 800,
        ease: 'Power2.easeOut',
        onComplete: () => {
          if (this.doorRightHalf) {
            this.doorRightHalf.destroy();
          }
        }
      });

      // Destroy original door sprite
    ...
    for (let i = 0; i < 40; i++) {
      ...
      const particle = this.scene.add.circle(this.x, this.y, 3 + Math.random() * 4, 0xffd700, 1)
        .setDepth(15);
    ...
    // Create overlap zone for player to walk through
    const overlapZone = this.scene.add.zone(this.x, this.y, 120, 160)
      .setDepth(5);
    this.scene.physics.world.enable(overlapZone, Phaser.Physics.Arcade.STATIC_BODY);
    const zoneBody = overlapZone.body as Phaser.Physics.Arcade.StaticBody;
    zoneBody.setSize(120, 160);

    // Create overlap detector (not collider) so player can pass through
    this.doorOverlap = this.scene.physics.add.overlap(
      (this.scene as any).player,
      overlapZone,
      () => this.handlePlayerPassThrough(),
      undefined,
      this.scene
    );
  ...
  private handlePlayerPassThrough() {
    if (this.playerPassedThrough) return; // Only trigger once
    
    this.playerPassedThrough = true;
    
    // Show congratulations screen
    this.scene.scene.pause('GameScene');
    this.scene.scene.launch('UIScene', { word: 'LEVEL COMPLETE', isComplete: true });
  }
  ...
  public startListening() {
    ...
    // Show UI when listening starts (player reached end)
    if (this.challengeUI && !this.challengeUI.visible) {
      ...
      // Resume mic icon animation
      if (this.micIcon) {
        const micTween = this.scene.tweens.getTweensOf(this.micIcon)[0];
        if (micTween) {
          micTween.resume();
        }
      }
  ...
  public update() {
    ...
    // Check idle timeout
    this.idleTimer += 16; // Assuming ~60fps

    if (this.idleTimer > 10000) { // 10 seconds
      if (this.jumufGiveHint && this.showJumuf) {
        this.showJumuf();
